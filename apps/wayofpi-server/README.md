...
**Note**: Will be renamed from `wayofpi-server` to `wayofwork-server` to match the "Way of Work" branding.
...
Serves all frontends: `wayofpi-ui`, `wayofpi/technicalIDE`, `workerportal`.
