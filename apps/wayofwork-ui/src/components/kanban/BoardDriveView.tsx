  ...
  return (
    <div className="flex-1 overflow-y-auto pl-4 pr-2 lg:pl-6 py-4">
      <div className="max-w-7xl mx-auto">
        ...
        {folders.length > 0 && (
          <div className="mb-6">
            <h4 className="text-sm font-semibold text-gray-300 mb-4">Folders</h4>
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
              {folders.map((folder) => (
                <button
                  key={folder.id}
                  onClick={() => handleFolderClick(folder.id)}
                  className="bg-gray-800 border border-gray-700 rounded-lg p-4 hover:border-purple-500 transition-colors text-left"
                >
        ...
        {allLinked.length > 0 && (
          <div className="mb-8">
            <h4 className="text-sm font-semibold text-gray-300 mb-4">Linked Files</h4>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {unlinked.map((file) => (
                  ...
                  >
                    ...
                    {!selectedCardId && (
                      <div className="mt-3">
                        <p className="text-xs text-gray-500 mb-2">Select a card to link:</p>
                        <div className="flex flex-wrap gap-1">
        ...
        {!isLinkingMode && allLinked.length === 0 && unlinked.length === 0 && (
          <div className="text-center py-12 text-gray-500">
            ...
            <button
              ...
              className="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-lg text-sm font-medium transition-colors flex items-center gap-2 mx-auto"
            >
              <Link2 className="w-4 h-4" />
              Link File
            </button>
