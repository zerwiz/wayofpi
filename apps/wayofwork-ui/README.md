...
**Note**: This app will be renamed from `wayofwork-ui` to `wayofwork-ui` to reflect its role as the "Way of Work" platform, while "Way of Pi" becomes the technical IDE in `apps/wayofpi/`.
