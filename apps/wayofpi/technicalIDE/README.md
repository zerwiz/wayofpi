...
- **Shared code**: Components/hooks from `wayofpi-ui/src/` via `@wop` alias
...
Requires API server on port 3333 (`apps/wayofpi-ui/server/`).
...
- `@wop/*` → `../wayofpi-ui/src/*` (shared components)
- `@/*` → `src/*` (app-internal)
