 ...
 * (the repo that contains `apps/wayofpi-ui/`), **not** under the mutable project
...
/** Repo root when running from `apps/wayofpi-ui/server/*.ts` (three hops: server → wayofpi-ui → apps → checkout). */
