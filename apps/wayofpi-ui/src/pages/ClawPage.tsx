...
interface EditorState {
  ...
  handleNewPlanFileCreate: (title: string, slugSuggestion: string) => void;
  ...
  return (
    ...
    >
      <ClawApp
        ...
        error={session.error}
        sendChat={(text) => void session.sendChat(text)}
        stop={session.stop}
        ...
        onOpenHostDoctor={menus.openHostDoctor}
        onHelp={(section) => {
          modals.setClawHelpDefaultSection(section ?? null);
        ...
        onMoveFileToDirectory={editor.handleExplorerMoveFile}
