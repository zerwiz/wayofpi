import { Folder, ChevronDown, ChevronRight, FileCode2, FileJson, File as FileIcon } from "lucide-react";
...
export function FileExplorer({
	...
	const itemHover = appearanceDark ? "hover:bg-[#2d2d2d]" : "hover:bg-[#f5f5f5]";
	const selectedBg = appearanceDark ? "bg-[#ea580c]/20" : "bg-[#ea580c]/12";
	const dirText = appearanceDark ? "text-[#cccccc]" : "text-[#333333]";
	const gitBadge = appearanceDark ? "bg-[#164e63] text-[#0ea5e9]" : "bg-[#cce0ff] text-[#0066ff]";
