...
function menuKbd(keys: string) {
  return (
    <span className="float-right ml-4 font-mono text-[10px] text-[#858585]">
      {keys}
    </span>
  );
}
...
export function MenuBar({
  ...
  const [viewFlyout, setViewFlyout] = useState<null | "appearance" | "layout">(
    null,
  );
  const [viewSimpleFlyout, setViewSimpleFlyout] = useState<
    null | "appearance" | "views"
  >(null);
  ...
  useEffect(() => {
    if (!openMenu && !modelOpen && !mobileActivityOpen && !mobileAppMenuOpen)
      return;
  ...
  const renderMenuPanels = (
    ...
    <>
      {openMenu === "File" && (label === "File" || mobileMenuPanelEmbed) ? (
        fileMenu ? (
          <FileMenuContent
            ...
            embed={mobileMenuPanelEmbed}
          />
        ) : (
          <ul
            className={
              mobileMenuPanelEmbed
                ? "relative z-50 mt-0 max-h-[min(52vh,520px)] w-full min-w-0 list-none overflow-y-auto border-0 border-t border-[#3c3c3c] bg-[#252526] py-1 shadow-none"
                : "absolute left-0 top-full z-50 mt-0.5 min-w-[240px] list-none border border-[#454545] bg-[#252526] py-1 shadow-xl"
            }
          >
            <li>
              <button
            ...
            <>
              <li>
                <button
                  ...
                  className={menuBtnClass(
                    !editMenu.canEdit || !editMenu.canUndo,
                  )}
                  onClick={() => {
                    editMenu.onUndo();
                    closeMenus();
              ...
              <li>
                <button
                  ...
                  className={menuBtnClass(
                    !editMenu.canEdit || !editMenu.canRedo,
                  )}
                  onClick={() => {
                    editMenu.onRedo();
                    closeMenus();
      ...
      {openMenu === "Selection" &&
      (label === "Selection" || mobileMenuPanelEmbed) ? (
        <ul
          className={
            mobileMenuPanelEmbed
              ? "relative z-50 mt-0 max-h-[min(52vh,520px)] w-full min-w-0 list-none overflow-y-auto border-0 border-t border-[#3c3c3c] bg-[#252526] py-1 shadow-none"
              : "absolute left-0 top-full z-50 mt-0.5 min-w-[320px] list-none border border-[#454545] bg-[#252526] py-1 shadow-xl"
          }
        >
          {selectionMenu ? (
            <>
      ...
      {openMenu === "View" && (label === "View" || mobileMenuPanelEmbed) ? (
        ...
        >
          ...
          {import.meta.env.DEV ||
          (typeof window !== "undefined" && window.wopShell) ? (
            <>
              <li className="my-1 border-t border-[#3c3c3c]" role="separator" />
              <li>
                <button
          ...
          <li>
            <button
              ...
              title={
                uiMode === "technical"
                  ? "Already using Technical layout."
                  : "Switch to IDE-style layout."
              }
              onClick={() => {
            ...
            <>
              <li className="relative">
                <button
                  ...
                  className={menuBtnClass()}
                  onClick={() =>
                    setViewSimpleFlyout((v) =>
                      v === "appearance" ? null : "appearance",
                    )
                  }
                >
                  Appearance
              ...
              <li className="relative">
                <button
                  ...
                  className={menuBtnClass()}
                  onClick={() =>
                    setViewSimpleFlyout((v) => (v === "views" ? null : "views"))
                  }
                >
                  Workspace views
                  <span className="float-right text-[#858585]">
                ...
                {viewSimpleFlyout === "views" ? (
                  ...
                  >
                    ...
                    {viewSimple.catalogLoading ? (
                      <li className="px-3 py-2 text-[#858585]">
                        Loading catalog…
                      </li>
                    ) : (
            ...
            <>
                  ...
                  <ul className={viewFlyoutClass()}>
                    ...
                    <li>
                      ...
                      >
                        ...
                        <span className="text-[#555]">(left only)</span>
                      </button>
                    </li>
                    <li>
                      <button
              ...
              <li className="relative">
                <button
                  ...
                  className={menuBtnClass()}
                  onClick={() =>
                    setViewFlyout((v) => (v === "layout" ? null : "layout"))
                  }
                >
                  Editor layout
                  <span className="float-right text-[#858585]">
                ...
                {viewFlyout === "layout" ? (
                  <ul className={viewFlyoutClass()}>
                    <li>
                      ...
                      >
                        Split up{" "}
                        <span className="text-[#555]">(editor splits n/a)</span>
                      </button>
                    </li>
                    <li>
                      <button
                    ...
                    <li>
                      <button
                        ...
                        className={menuBtnClass()}
                        onClick={() => {
                          viewTechnical.onApplyLayoutPreset(
                            "workspace_grid_3x1",
                          );
                          closeMenus();
                        }}
                    ...
                    <li>
                      ...
                      >
                        Grid (2×2){" "}
                        <span className="text-[#555]">(agent + panel)</span>
                      </button>
                    </li>
                    <li>
                      <button
          ...
          {onSetAgentChatDock != null &&
          onToggleAgentPanel != null &&
          agentChatDock != null &&
          agentPanelVisible != null ? (
            <>
              <li className="my-1 border-t border-[#3c3c3c]" />
              <li>
                <button
      ...
      {openMenu === "Go" && (label === "Go" || mobileMenuPanelEmbed) ? (
        <ul
          className={
            mobileMenuPanelEmbed
              ? "relative z-50 mt-0 max-h-[min(52vh,520px)] w-full min-w-0 list-none overflow-y-auto border-0 border-t border-[#3c3c3c] bg-[#252526] py-1 shadow-none"
              : "absolute left-0 top-full z-50 mt-0.5 min-w-[340px] list-none border border-[#454545] bg-[#252526] py-1 shadow-xl"
          }
        >
          {goMenu ? (
            <>
              <li>
                <button
                  ...
                  title={
                    !goMenu.canGoBack ? "No navigation history yet." : undefined
                  }
                  onClick={() => {
                    goMenu.onBack();
                    closeMenus();
              ...
              <li>
                <button
                  ...
                  title={
                    !goMenu.canGoForward ? "No forward history." : undefined
                  }
                  onClick={() => {
                    goMenu.onForward();
                    closeMenus();
            ...
            <>
              <li>
                ...
                >
                  <span className="inline-flex items-center gap-2">
                    <Info
                      className="h-3.5 w-3.5 shrink-0 text-[#3794ff]"
                      aria-hidden
                    />
                    How debugging works
                  </span>
              ...
              <li>
                <button
                  type="button"
                  disabled={
                    !runMenu.terminalServerEnabled || !runMenu.canStartDebugging
                  }
                  className={menuBtnClass(
              ...
              <li>
                <button
                  type="button"
                  disabled={
                    !runMenu.debugSessionActive || !runMenu.debugReplSession
                  }
                  className={menuBtnClass(
                    !runMenu.debugSessionActive || !runMenu.debugReplSession,
                  )}
              ...
              <li>
                <button
                  type="button"
                  disabled={
                    !runMenu.hasBreakpoints || !runMenu.allBreakpointsDisabled
                  }
                  className={menuBtnClass(
                    !runMenu.hasBreakpoints || !runMenu.allBreakpointsDisabled,
                  )}
      ...
      {openMenu === "Terminal" &&
      (label === "Terminal" || mobileMenuPanelEmbed) ? (
        <ul
          className={
            mobileMenuPanelEmbed
              ? "relative z-50 mt-0 max-h-[min(52vh,520px)] w-full min-w-0 list-none overflow-y-auto border-0 border-t border-[#3c3c3c] bg-[#252526] py-1 shadow-none"
              : "absolute left-0 top-full z-50 mt-0.5 min-w-[300px] list-none border border-[#454545] bg-[#252526] py-1 shadow-xl"
          }
        >
          {terminalMenu ? (
            <>
      ...
      {openMenu === "Settings" &&
      (label === "Settings" || mobileMenuPanelEmbed) ? (
        <ul
          className={
            mobileMenuPanelEmbed
              ? "relative z-50 mt-0 max-h-[min(52vh,520px)] w-full min-w-0 list-none overflow-y-auto border-0 border-t border-[#3c3c3c] bg-[#252526] py-1 shadow-none"
              : "absolute left-0 top-full z-50 mt-0.5 min-w-[min(340px,92vw)] list-none border border-[#454545] bg-[#252526] py-1 shadow-xl"
          }
        >
          {settingsMenu ? (
            <>
    ...
    <header className="pointer-events-auto fixed left-0 right-0 top-0 z-[95] flex h-8 w-full min-w-0 max-w-full select-none items-center gap-2 border-b border-[#252526] bg-[#323233] px-2 sm:px-3">
      ...
      <div className="flex min-w-0 flex-1 items-center gap-2 overflow-x-visible sm:gap-4">
        ...
        <div className="scrollbar-hide flex shrink-0 items-center gap-2 overflow-x-auto [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          ...
          >
            <TerminalSquare
              size={14}
              className="shrink-0 text-[#007acc]"
              aria-hidden
            />
                  ...
                  <li key={id} role="none">
                    ...
                    >
                      <Icon
                        size={16}
                        strokeWidth={1.5}
                        className="shrink-0 text-[#858585]"
                        aria-hidden
                      />
                      <span className="min-w-0 flex-1">{label}</span>
                      {technicalActivity === id ? (
                        <span className="shrink-0 font-mono text-[10px] text-[#89d185]">
                          ✓
                        </span>
                      ) : null}
                    </button>
        ...
        <div
          ...
          className="relative z-[71] shrink-0 md:hidden"
        >
          <button
            type="button"
          ...
          {mobileAppMenuOpen ? (
            ...
            >
              {!openMenu ? (
                <ul
                  className="max-h-[min(40dvh,320px)] list-none overflow-y-auto py-1"
                  role="none"
                >
                  {menuLabels.map((l) => (
                    <li key={l} role="none">
                ...
                <>
                  ...
                  <div className="min-h-0 flex-1 overflow-y-auto">
                    {openMenu
                      ? renderMenuPanels(
                          true,
                          openMenu as (typeof menuLabels)[number],
                        )
                      : null}
                  </div>
                </>
      ...
      <div className="ml-auto flex shrink-0 items-center gap-1.5 sm:gap-4">
        ...
        >
          ...
          <span className="hidden text-[12px] text-[#cccccc] md:inline">
            Search or command…
          </span>
          <span className="hidden font-mono text-[10px] font-bold text-[#969696] md:ml-1 md:inline">
            ⌘K
          </span>
        </button>
        ...
        <div className="relative" ref={modelRef}>
          ...
          >
            ...
            />
            <span
              className="hidden min-w-0 truncate font-mono md:block"
              title={modelLabel}
            >
              {modelLabel}
            </span>
            <ChevronDown
              ...
              aria-hidden
            />
            <span className="text-[10px] font-mono text-[#858585] ml-0.5">
              ({uisModels?.length ?? 0})
            </span>
          ...
          {modelOpen ? (
            <ModelSelectorModal
              ...
              onAddModel={() => {
                onOpenPiModelConfig("agent/models.json");
                setModelOpen(false);
              }}
              loading={config?.provider === "ollama"}
              error={null}
            />
          ) : null}
        </div>
      ...
      {debugHelpOpen ? (
        ...
        >
          ...
          >
            ...
            <div
              id="debug-help-desc"
              className="mt-3 space-y-3 text-[13px] leading-relaxed text-[#cccccc]"
            >
              <p>
                Way of Pi does not embed the full VS Code debugger. Commands in{" "}
                <strong className="text-[#e0e0e0]">Run</strong> send lines to
                the{" "}
                <strong className="text-[#e0e0e0]">integrated terminal</strong>,
                so the server must allow PTYs (
                <span className="font-mono text-[#9cdcfe]">
                  WOP_ALLOW_TERMINAL=1
                </span>
                ).
              </p>
              <p>
                <strong className="text-[#e0e0e0]">Open Configurations</strong>{" "}
                opens{" "}
                <code className="text-[#9cdcfe]">.vscode/launch.json</code>.{" "}
                <strong className="text-[#e0e0e0]">Add Configuration…</strong>{" "}
                appends a Cursor/VS Code-style template (Node, Bun, Python
                debugpy, or attach) then opens the file — use those entries in
                Cursor when you work in the same workspace.
              </p>
              <p>
                <strong className="text-[#e0e0e0]">
                  Install Additional Debuggers…
                </strong>{" "}
                opens Marketplace and doc links so you can install{" "}
                <strong className="text-[#e0e0e0]">DAP</strong> extensions in
                Cursor / VS Code (Python debugpy, CodeLLDB, Go, Bun, Java, PHP,
                .NET, Ruby, and more).
              </p>
              <p>
                <strong className="text-[#e0e0e0]">Start Debugging</strong> (
                <kbd className="rounded bg-[#3c3c3c] px-1 font-mono text-[11px]">
                  F5
                </kbd>
                ...
                for TypeScript,{" "}
                <span className="font-mono text-[#9cdcfe]">python3 -m pdb</span>{" "}
                for Python. Attach Node/Bun with your browser or IDE inspector
                (e.g. open{" "}
                <span className="font-mono text-[#9cdcfe]">
                  chrome://inspect
                </span>
              ...
              <p>
                ...
                ) sends Ctrl+C to the terminal and clears the in-app debug
                session.
              </p>
              <p>
                For <strong className="text-[#e0e0e0]">Python pdb</strong>,
                Continue / Step in the menu (and{" "}
                <kbd className="rounded bg-[#3c3c3c] px-1 font-mono text-[11px]">
                  F5
                </kbd>{" "}
                /{" "}
                ...
                ) send pdb commands when those items are enabled. Editor gutter
                breakpoints are not yet wired to the runtime.
              </p>
            </div>
            <button
              type="button"
        ...
        >
          ...
          >
            ...
            <p className="mt-2 text-[13px] leading-relaxed text-[#cccccc]">
              Technical web shell for the Pi extension playground. Chat and
              workspace tools use the{" "}
              <strong className="font-semibold text-[#e0e0e0]">
                folder you open
              </strong>{" "}
              as the workspace. Upstream Pi is{" "}
              <a
            ...
            <ul className="mt-1.5 list-disc space-y-1.5 pl-5 text-[13px] leading-relaxed text-[#cccccc]">
              <li>
                ...
                — get step-by-step help building apps, scripts, homework
                projects, or fixing bugs while the AI can read the same files
                you see in the tree (when tools or Pi-backed chat are enabled).
              </li>
              <li>
                <strong className="font-semibold text-[#e0e0e0]">
                  Documents and plans
                </strong>{" "}
                — keep READMEs, plans (like{" "}
                <span className="font-mono text-[12px] text-[#9cdcfe]">
                  plans/
                </span>
                ), and internal write-ups next to the code so your team&apos;s
              ...
              <li>
                ...
                — ask how things work, trace errors, or sketch a design;
                optional terminal and Git helpers when your operator turns them
                on.
              </li>
              <li>
                <strong className="font-semibold text-[#e0e0e0]">
                  Company or club playbooks
                </strong>{" "}
                — check this repo into git and share the same extensions,
                agents, and docs so everyone follows the same playbook (still
                your own API keys and machines).
              </li>
            </ul>
            <p className="mt-3 text-[12px] leading-relaxed text-[#9d9d9d]">
              Heavy automation (editing files, running commands) depends on your
              Settings, orchestrator toggles, and whether chat runs through the
              Pi CLI — see{" "}
              <strong className="font-semibold text-[#b0b0b0]">
                Help → Host doctor
              </strong>{" "}
              and the <span className="font-mono text-[11px]">docs/</span>{" "}
              folder in the Way of Pi checkout (for example{" "}
