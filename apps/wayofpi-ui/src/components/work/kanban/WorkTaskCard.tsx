  ...
  return (
    <>
      ...
      {previewImage && (
        ...
        >
          <div className="relative max-w-5xl max-h-[90vh] w-full h-full flex items-center justify-center">
            ...
            <button
              onClick={() => setPreviewImage(null)}
              className="absolute top-4 right-4 p-2 bg-dark-800 hover:bg-dark-700 rounded-lg text-[#cccccc] transition-colors"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4">
        <div
          className="bg-[#1e1e1e]/80 backdrop-blur-sm rounded-lg !max-w-[560px] w-[90vw] sm:!w-[560px] max-h-[calc(100vh-1rem)] sm:max-h-[90vh] overflow-y-auto border border-purple-500/30 shadow-2xl shadow-purple-500/10"
          onClick={(e) => e.stopPropagation()}
        >
          {/* Header */}
          <div className="sticky top-0 bg-[#1e1e1e]/80 backdrop-blur-sm border-b border-purple-500/20 p-4 md:p-6 flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 sm:gap-0 z-10">
            <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
              <button
                onClick={onClose}
                className="p-2 hover:bg-[#252526]/50 rounded-lg transition-colors group flex-shrink-0 min-h-[44px] min-w-[44px] flex items-center justify-center"
                title="Go Back"
              >
                <ArrowLeft className="w-5 h-5 text-[#858585] group-hover:text-purple-400" />
              </button>
              <div className="flex-1 min-w-0">
                {(isCreateMode || isEditing) ? (
                  <input
                    ...
                    className="text-xl sm:text-2xl font-bold bg-transparent border-0 border-b-2 border-purple-500 focus:outline-none w-full text-[#cccccc] min-h-[44px]"
            ...
            <div className="flex items-center gap-2 flex-wrap sm:flex-nowrap">
              {isCreateMode ? (
                <>
                  <button
                    onClick={handleSave}
                    className="flex-1 sm:flex-none px-4 py-2 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-[#cccccc] rounded-lg flex items-center justify-center gap-2 transition-all shadow-lg shadow-green-500/20 text-sm sm:text-base min-h-[44px]"
                  >
                  ...
                  <button
                    onClick={onClose}
                    className="flex-1 sm:flex-none px-4 py-2 bg-[#252526] hover:bg-gray-600 text-[#cccccc] rounded-lg transition-colors text-sm sm:text-base min-h-[44px]"
                  >
                    Cancel
                  </button>
                </>
                ...
                <>
                  <button
                    onClick={handleSave}
                    className="flex-1 sm:flex-none px-4 py-2 bg-gradient-to-r from-[#ea580c] to-[#c2410c] hover:from-purple-700 hover:to-pink-700 text-[#cccccc] rounded-lg flex items-center justify-center gap-2 transition-all shadow-lg shadow-purple-500/20 text-sm sm:text-base min-h-[44px]"
                  >
                ...
                <button
                  ...
                  className="flex-1 sm:flex-none px-4 py-2 bg-gradient-to-r from-[#ea580c] to-[#c2410c] hover:from-purple-700 hover:to-pink-700 text-[#cccccc] rounded-lg transition-all shadow-lg shadow-purple-500/20 text-sm sm:text-base min-h-[44px]"
                >
                  Edit
                </button>
              )}
              <button
                onClick={onClose}
                className="p-2 hover:bg-[#252526]/50 rounded-lg transition-colors min-h-[44px] min-w-[44px] flex items-center justify-center"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
          ...
          <div className="p-3 sm:p-4 md:p-6 space-y-4">
            ...
            <div>
              ...
              {(isCreateMode || isEditing) ? (
                <textarea
                  ...
                  rows={3}
                  className="w-full px-4 py-2 bg-[#252526] border border-[#3c3c3c] rounded-lg text-[#cccccc] placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500"
                  placeholder="Enter card description"
                />
              ) : (
                <p className="text-sm text-[#cccccc] whitespace-pre-wrap">{card?.description || 'No description'}</p>
              )}
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div>
                ...
                {(isCreateMode || isEditing) ? (
                  <select
                    ...
                    className="w-full px-4 py-2 bg-[#252526] border border-[#3c3c3c] rounded-lg text-[#cccccc] focus:outline-none focus:ring-2 focus:ring-purple-500"
                  >
              ...
              {/* Estimated Time */}
              <div>
                <label className="block text-xs sm:text-sm font-semibold text-[#cccccc] mb-2 flex items-center gap-2">
            ...
            {(isCreateMode || isEditing) && (
              <div>
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-4 py-2 bg-[#252526] hover:bg-gray-600 border border-[#3c3c3c] rounded-lg text-sm transition-colors text-[#cccccc]"
                >
                  {displayData?.cover ? 'Change Cover' : 'Add Cover'}
                </button>

                {showCoverPicker && (
                  <div className="mt-3 p-4 bg-[#252526]/40 border border-[#3c3c3c]/30 rounded-lg">
                    <h4 className="font-medium text-sm mb-3 text-[#cccccc]">Choose Cover Type</h4>
                          ...
                          <button
                            ...
                            className={`w-10 h-10 rounded-lg border-2 transition-all flex-shrink-0 ${
                              editedCard.cover?.value === colorOption.value
                                ...
                                : 'border-[#3c3c3c] hover:border-gray-500'
                            }`}
                          ...
                          {(editedCard.attachments || card?.attachments || [])
                            ...
                            .map((attachment) => (
                              <button
                                ...
                                className="w-full h-16 sm:h-20 rounded-lg overflow-hidden border-2 border-[#3c3c3c] hover:border-purple-500/50 transition-colors relative group"
                              >
                                <img
                                  src={attachment.url}
                                  alt={attachment.name}
                                ...
                                <div className="absolute inset-0 bg-black/0 group-hover:bg-black/30 transition-colors flex items-center justify-center">
                                  <ImageIcon className="w-4 h-4 text-[#cccccc] opacity-0 group-hover:opacity-100 transition-opacity" />
                                </div>
                              </button>
                            ))}
                        </div>
                    ...
                    <div className="mb-4">
                      ...
                      <button
                        ...
                        className="w-full px-4 py-2 bg-[#252526] hover:bg-gray-600 border border-[#3c3c3c] rounded-lg text-sm transition-colors text-[#cccccc] flex items-center justify-center gap-2"
                      >
            ...
            <div>
                  ...
                  {(editedCard.attachments || card?.attachments || []).map((attachment) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-xs sm:text-sm text-[#cccccc] truncate font-medium">{attachment.name}</p>
              ...
              {(isCreateMode || isEditing) && (
                <div
                  className="border-2 border-dashed border-[#3c3c3c] rounded-lg p-6 text-center hover:border-purple-500/50 transition-colors cursor-pointer"
                  onDragOver={(e) => {
                    e.preventDefault();
                    e.stopPropagation();
                  }}
                ...
                >
                  ...
                  {uploadingFiles ? (
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-[#cccccc]">Click or drag files to upload</p>
            ...
            <div>
              ...
              <div className="space-y-2">
                {(displayData?.assignees || []).map((assignee) => (
                  <div
                    key={assignee.userId}
                    className="flex items-center justify-between p-2 bg-[#252526]/40 border border-[#3c3c3c]/30 rounded-lg"
                  >
                    <div className="flex items-center gap-2 flex-1 min-w-0">
                      <div className="w-8 h-8 rounded-full bg-gradient-to-br from-blue-500 to-purple-500 flex items-center justify-center text-sm font-medium text-[#cccccc] flex-shrink-0">
                        {assignee.avatar ? (
                          <img
                            src={assignee.avatar}
                ...
                {(isCreateMode || isEditing) && (
                  <>
                    <button
                      ...
                      className="w-full px-4 py-2 border-2 border-dashed border-[#3c3c3c] hover:border-purple-500/50 rounded-lg text-[#858585] hover:text-purple-400 transition-colors flex items-center justify-center gap-2 text-sm"
                    >
                    ...
                    {showUserSearch && (
                      <div className="p-3 bg-[#252526]/40 border border-[#3c3c3c]/30 rounded-lg space-y-2">
                        <div className="flex gap-2">
                          <input
                            ...
                            className="flex-1 px-3 py-2 bg-[#252526] border border-[#3c3c3c] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 text-[#cccccc] placeholder-gray-500"
                          />
                        </div>
                          ...
                          <div className="max-h-40 overflow-y-auto space-y-1">
                            {filteredUsers.map((user) => (
                              <button
                                ...
                                className="w-full flex items-center gap-2 p-2 bg-[#1e1e1e] hover:bg-[#252526] rounded text-left transition-colors"
                              >
                                <div className="w-6 h-6 rounded-full bg-gradient-to-br from-blue-500 to-purple-500 flex items-center justify-center text-xs text-[#cccccc]">
            ...
            <div>
              ...
              <div className="space-y-3">
                {(displayData?.checklists || []).map((checklist) => (
                  <div key={checklist.id} className="p-3 bg-[#252526]/40 border border-[#3c3c3c]/30 rounded-lg">
                    <h4 className="text-sm font-medium text-[#cccccc] mb-2">{checklist.title}</h4>
                    <div className="space-y-1">
                      {checklist.items.map((item) => (
                        <div key={item.id} className="flex items-center gap-2">
                          <input
                            ...
                            className="w-4 h-4 rounded border-[#3c3c3c] text-purple-500 focus:ring-2 focus:ring-purple-500"
                          />
                          <span
                            className={`text-sm ${
                              item.completed ? 'line-through text-[#585858]' : 'text-[#cccccc]'
                            }`}
                          >
                            {item.title}
                          </span>
                    ...
                    {showChecklistForm ? (
                      <div className="p-3 bg-[#252526]/40 border border-[#3c3c3c]/30 rounded-lg space-y-2">
                        <input
                          ...
                          className="w-full px-3 py-2 bg-[#252526] border border-[#3c3c3c] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 text-[#cccccc] placeholder-gray-500"
                        />
                        <div className="flex gap-2">
                          <button
                            onClick={handleAddChecklist}
                            className="px-3 py-1 bg-gradient-to-r from-[#ea580c] to-[#c2410c] hover:from-purple-700 hover:to-pink-700 text-[#cccccc] rounded text-sm transition-colors"
                          >
                            Add
                          </button>
                          <button
                            ...
                            className="px-3 py-1 bg-[#252526] hover:bg-gray-600 text-[#cccccc] rounded text-sm transition-colors"
                          >
                            Cancel
                          </button>
                        </div>
            ...
            <div>
              ...
              {((!isCreateMode && card && card.metadata && (card.metadata.noteId || card.metadata.taskIds || card.metadata.taskId || card.metadata.taskListId || card.metadata.fileId || card.metadata.calendarEventId)) ||
                ...
                <div className="p-3 bg-[#252526]/40 border border-[#3c3c3c]/30 rounded-lg space-y-2 mb-2">
              ...
              {(isCreateMode || isEditing) && (
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                  <button
                    ...
                    className="flex-1 px-4 py-2 border-2 border-dashed border-[#3c3c3c] hover:border-blue-500/50 rounded-lg text-[#858585] hover:text-blue-400 transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed text-sm"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 px-4 py-2 border-2 border-dashed border-[#3c3c3c] hover:border-green-500/50 rounded-lg text-[#858585] hover:text-green-400 transition-colors flex items-center justify-center gap-2 text-sm"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 px-4 py-2 border-2 border-dashed border-[#3c3c3c] hover:border-purple-500/50 rounded-lg text-[#858585] hover:text-purple-400 transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed text-sm"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 px-4 py-2 border-2 border-dashed border-[#3c3c3c] hover:border-orange-500/50 rounded-lg text-[#858585] hover:text-orange-400 transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed text-sm"
                  >
                  ...
                  <div className="flex gap-2">
                    <div className="relative flex-1">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-3 py-2 bg-dark-800 border border-dark-600 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 text-[#cccccc] placeholder-gray-500"
                      />
                    </div>
                    <button
                      onClick={() => {
                      ...
                      className="px-3 py-2 bg-dark-600 hover:bg-dark-500 text-[#cccccc] rounded-lg text-sm"
                    >
                      Cancel
                    </button>
                  </div>
                    ...
                    <div className="max-h-40 overflow-y-auto space-y-1">
                      {filteredNotes.map((note) => (
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            <p className="text-sm font-medium text-[#cccccc] truncate">{note.title}</p>
              ...
              {showLinkTask && (isCreateMode || isEditing) && (
                <div className="mt-3 p-4 bg-[#252526]/40 border border-[#3c3c3c]/30 rounded-lg space-y-2">
                  <div className="flex gap-2">
                    <div className="relative flex-1">
                      <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-[#858585]" />
                      <input
                        ...
                        className="w-full pl-10 pr-3 py-2 bg-[#252526] border border-[#3c3c3c] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-green-500 text-[#cccccc] placeholder-gray-500"
                      />
                    </div>
                    <button
                      onClick={() => {
                      ...
                      className="px-3 py-2 bg-[#252526] hover:bg-gray-600 text-[#cccccc] rounded-lg text-sm transition-colors"
                    >
                      Cancel
                    </button>
                  </div>
                    ...
                    <div className="max-h-40 overflow-y-auto space-y-1">
                      {filteredTasks.map((task) => (
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            <p className="text-sm font-medium text-[#cccccc] truncate">{task.title}</p>
                            <p className="text-xs text-[#858585] truncate">
                  ...
                  <div className="flex gap-2">
                    <div className="relative flex-1">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-3 py-2 bg-dark-800 border border-dark-600 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 text-[#cccccc] placeholder-gray-500"
                      />
                    </div>
                    <button
                      onClick={() => {
                    ...
                    <div className="max-h-40 overflow-y-auto space-y-1">
                      {filteredFiles.map((file) => (
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            <p className="text-sm font-medium text-[#cccccc] truncate">{file.name}</p>
                            <p className="text-xs text-[#858585] truncate">
                  ...
                  <div className="flex gap-2">
                    <div className="relative flex-1">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-3 py-2 bg-dark-800 border border-dark-600 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 text-[#cccccc] placeholder-gray-500"
                      />
                    </div>
                    <button
                      onClick={() => {
                    ...
                    <div className="max-h-40 overflow-y-auto space-y-1">
                      {filteredCalendarEvents.map((event) => (
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            <p className="text-sm font-medium text-[#cccccc] truncate">{event.title}</p>
                            <p className="text-xs text-[#858585] truncate">
              ...
              <div>
                  ...
                  {(card.comments || []).map((comment) => (
                    <div key={comment.id} className="p-3 bg-dark-700 rounded-lg">
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-sm font-medium text-[#cccccc]">{comment.userName || 'Unknown User'}</span>
                        <span className="text-xs text-[#858585]">
                          {new Date(comment.createdAt).toLocaleString()}
                        </span>
                      </div>
                      <p className="text-sm text-[#cccccc]">{comment.content || ''}</p>
                    </div>
                  ))}
                </div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-4 py-2 bg-dark-700 border border-dark-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-[#cccccc] placeholder-gray-500"
                  />
                  <button
                    onClick={handleAddComment}
                    disabled={!newComment.trim()}
                    className="px-4 py-2 bg-blue-500 hover:bg-blue-600 text-[#cccccc] rounded-lg disabled:opacity-50 transition-colors"
                  >
                    Send
                  </button>
                </div>
