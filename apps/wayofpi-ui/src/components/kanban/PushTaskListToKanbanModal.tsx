        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-4">
          ...
          {tasksInList.length > 0 && (
            <div>
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="px-3 py-1 text-xs bg-gray-800/60 hover:bg-gray-700/80 text-gray-300 hover:text-white rounded-lg transition-all border border-gray-700/50 hover:border-gray-600"
                  >
                    Select All
                  </button>
                  <button
              ...
              <div className="max-h-64 overflow-y-auto space-y-2 border border-purple-500/30 rounded-lg p-3 bg-gray-800/30">
          ...
          {tasksInList.length === 0 && (
            <div className="text-center py-8 text-gray-400 border border-gray-700/50 rounded-lg bg-gray-800/30">
