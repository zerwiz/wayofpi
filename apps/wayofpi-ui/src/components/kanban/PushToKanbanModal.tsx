        ...
        <div className="p-6 space-y-4">
          ...
          {pushMode === 'existing' && selectedBoardId && selectedColumnId && (
            <div>
              ...
              {availableCards.length === 0 ? (
                <div className="px-4 py-3 bg-gray-800/60 border border-purple-500/30 rounded-lg text-center text-gray-400">
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-4 py-2 bg-gray-800/60 backdrop-blur-sm border border-purple-500/30 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500/50 text-white input-text transition-all hover:border-purple-500/50 resize-none"
