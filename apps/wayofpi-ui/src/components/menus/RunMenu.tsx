...
export const RunMenu: React.FC<{ handlers: RunMenuHandlers }> = ({
  ...
  const debugActions = useMemo(() => ({
    ...
    onToggleBp: handlers.onToggleBreakpoint,
    onNewBpInline: handlers.onNewBreakpointInline,
    onNewBpConditional: handlers.onNewBreakpointConditional,
    onNewBpLogpoint: handlers.onNewBreakpointLogpoint,
    onNewBpTriggered: handlers.onNewBreakpointTriggered,
    onNewBpFunction: handlers.onNewBreakpointFunction,
    onEnableAllBps: handlers.onEnableAllBreakpoints,
    onDisableAllBps: handlers.onDisableAllBreakpoints,
    onRemoveAllBps: handlers.onRemoveAllBreakpoints,
    onInstallDebuggers: handlers.onInstallAdditionalDebuggers,
  }), [handlers]);
