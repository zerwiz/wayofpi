	...
	return (
		<>
			...
			<P>
				...
				<Code>apps/wayofpi-ui/src/claw/clawUserUiModules.ts</Code> (API in{" "}
				<Code>apps/wayofpi-ui/src/claw/clawUiModules.ts</Code>). Icons appear after{" "}
	...
	return (
		<>
			...
			<Tip>
				...
				<Code>apps/wayofpi-ui/src/claw/clawUiModules.ts</Code> inside{" "}
				<Code>apps/wayofpi-ui/src/claw/clawUserUiModules.ts</Code> (imported at app startup).
