	...
	return (
		<>
			...
			<DevBox>
				...
				<Chip>./start-wayofpi-ui.sh</Chip> (browser). The Bun server binds to port{" "}
	...
	return (
		<>
			...
			<DevBox>
				...
				<Chip>apps/wayofpi-ui/.env.sample</Chip>.
			</DevBox>
		</>
	);
}
	...
	return (
		<>
			...
			<P>
				...
				restart the server. Full list: <Chip>apps/wayofpi-ui/.env.sample</Chip>.
			</P>
			...
			<UL>
				...
				<li><Chip>just wayofpi-ui</Chip> — start browser dev server</li>
