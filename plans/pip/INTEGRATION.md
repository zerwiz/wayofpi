...
1.  **Protected Tier (Way of Pi)**: Located in `.pi/extensions/protected/`. Managed by `apps/wayofwork-ui`. These are high-stability versions of critical tools.
