...
- **`../apps/wayofwork-ui/public/wayofpi-icon.svg`** — Vector variant for the web favicon and sharp scaling.
...
- **`StartupWMClass=wayofpi`** (in the generated `.desktop`) plus **`app.setName("wayofpi")`** and **`desktopName`** in **`apps/wayofwork-ui/package.json`** help GNOME/KDE associate the running window with this menu entry.
